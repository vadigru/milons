<header>
  <div class="bcc">
    ...
    <div class="logo">
      ...
      <span class="klubs"><h1>Борцовский клуб</h1> <span class="milons"><h1>Milons</h1></span></span>
    </div>
        ...
        <ul>
          <li>
            ...
            <ul class="club_submenu">
              <li>
                <a href="club.php" class="menu_btn">Клуб</a>
              </li>
              <li>
                <a href="coach.php" class="menu_btn">Тренер</a>
              </li>
            </ul>
          </li>
          <li>
          ...
          <li>
            <a href="gallery.php" class="menu_btn">Галерея</a>
          </li>
          <li>
            ...
            <ul class="schedule_submenu">
              <li>
                <a href="schedule.php#group_1" class="menu_btn">Группа 1</a>
              </li>
              <li>
                <a href="schedule.php#group_2" class="menu_btn">Группа 2</a>
              </li>
              <li>
                <a href="schedule.php#group_3" class="menu_btn">Группа 3</a>
              </li>
            </ul>
          </li>
          <li>
            <a href="contacts.php" class="menu_btn">Контакты</a>
          </li>
          <li>
            <div class="lang">
